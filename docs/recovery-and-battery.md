...
The final review-fixed implementation `a02e6df` passed all 96 top-level ARM tests across eight test binaries on the RM1, including critical-path, retry-backoff, restore ordering and partial-restore regressions. Tested candidate SHA-256: `92602368aa4f1b8ee587f40bcb3cb8c41fa6a747c04117fea7fd9161476e28f9`. The production appliance remains on merged foundation `eafb1d1`; the issue candidate was exercised with isolated state/configuration. Temporary test services were removed and the live production display restored.
